...
joint_list = [[15, 13, 11],[13, 11, 23],[16, 14, 12]]
#([Left Wrist, Left Elbow, Left Shoulder],[Right Elbow, Right Shoulder, Right Hip],[Left Elbow, Left Shoulder, Left Hip],[Right Wrist, Right Elbow, Right Shoulder])
# For calculatioins of body part angles 
joint_list2 = [[24, 12, 11],[23, 11, 12],[12, 24, 23],[11, 23, 24],[14, 12, 24]]
...
def CalculateAngles(results, img, joint_list, start_time, frame_count, img_scale=(520, 600)):
    ...
    """
    angle = 0 # Initialize angle with a default value
