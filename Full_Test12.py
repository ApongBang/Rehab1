...
# Make Webhooks URL網址
webhook_url = "https://hook.us2.make.com/iklpw4fwj4a69380avqmpdy1zx9ovebx"

# Error_Frame = round(Error_Frame, 3)
# mean2 = round(mean2, 3)

data = {
    'error_frames': Error_Frame,  # 錯誤影格的列表
    'total_errors': len(Error_Frame),  # 錯誤影格的總數
}
